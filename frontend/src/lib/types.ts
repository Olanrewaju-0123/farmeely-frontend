...
export interface SignupPayload {
  ...
  location: string;
  address: string;
  // role is set by backend, not included in signup payload
}
...
export interface Group {
  ...
  groupName: string; // Primary group name field
  group_name?: string; // Alternative group name field for backward compatibility
  group_description?: string; // Alternative description field for backward compatibility
  ...
  start_date?: string; // Matches CreateGroups.start_date
  end_date?: string; // Matches CreateGroups.end_date
  group_image_url?: string;
